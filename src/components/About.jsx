      ...
      <div className="about-content max-w-4xl flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="about-text lg:w-2/3">
          ...
          <p className="text-gray-400 text-lg">
            My name is <span className="text-highlight">Nikita Yadav</span> and I am currently pursuing my Bachelor of Computer Applications (BCA), 2nd year, at Sant Singaji Institute of Science and Management, Sandalpur. 
          </p>
